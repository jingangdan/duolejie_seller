...
public class ZhuanZhangAdapter extends BaseAdapter {
	
	List<Map<String, Object>> data = new ArrayList<Map<String, Object>>();
	private Activity c;
	String key;
	private ImageLoadingListener animateFirstListener = new AnimateFirstDisplayListener();// 图片缓存
	public ZhuanZhangAdapter(Activity c, List<Map<String, Object>> data,String key) {
		this.c = c;
		this.data = data;
		this.key = key;
	}
...
//		Log.e("size", data.size()+"");
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (null == convertView)
        {
            ...
            convertView = mInflater.inflate(R.layout.azhuanzhang_list_items, null);
        ...
        viewHolder.tv_jia.setText(data.get(position).get("total_money").toString());
