...
//		Double aaaa = getIntent().getDoubleExtra("geoLat", 39.90403);
		float latitude = (float)(getIntent().getDoubleExtra("geoLat", 37.063112));
		float longitude = (float)(getIntent().getDoubleExtra("geoLng", 119.344225)); 
		latlat = (double)(getIntent().getDoubleExtra("geoLat", 37.063112));
		longlong = (double)(getIntent().getDoubleExtra("geoLng", 119.344225)); 
...
//			aMap.setOnMapLongClickListener(this);// 对amap添加长按地图事件监听器
			...
			LatLng latLng = new LatLng(latlat,longlong);//构造一个位置
//			LatLng latLng = new LatLng(35.063112, 118.344225);//构造一个位置
