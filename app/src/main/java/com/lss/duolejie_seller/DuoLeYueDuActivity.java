 ...
 * 
 */
public class DuoLeYueDuActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initView(R.layout.ui_duoleyuedu);
		initUI();
	...
	private void initUI() {
		...
		im_loginback.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				DuoLeYueDuActivity.this.finish();
			}
		});
		tencent_webviewx = (WebView) findViewById(R.id.webview);
		String url = "http://39.107.14.118/appInterface/aboutUsContentInfo.jhtml?id=24";
